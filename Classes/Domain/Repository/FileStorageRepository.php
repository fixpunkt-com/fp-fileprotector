...
class FileStorageRepository {
    /**
     * Gibt ein Array mit allen FileStorages zurück.
    ...
    /**
     * Gibt einen einzelnen ResourceStorage zurück.
    ...
    /**
     * Aktualisiert einen FileStorage.
    ...
    public function update(ResourceStorage $fileStorage) : void {
        ...
        $query = $queryBuilder
            ...
            -> set('protected_by_default', $fileStorage -> isProtectedByDefault())
            ->where(
                $queryBuilder->expr()->eq('uid', $queryBuilder->createNamedParameter($fileStorage -> getUid()))
            )
            -> execute();
    }
}